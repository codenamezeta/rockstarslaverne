  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(/images/jamcamp-bg.jpg)',
        }}
      >
          ...
          <div className='d-table-cell'>
            <div className='container'>
              <div className='row' style={{ marginTop: '5em' }}>
                <div className='col-lg-6 col-md-12'>
                  <div className='app-banner-content'>
                    ...
                    <p>
                      ...
                      bass, drums, piano, and/or vocals. Students can choose to
                      play on as many instruments as they want or just stick
                      with one or two their favorites. Open to all skill levels
                      and ages 7 and above.
                    </p>
                    ...
                    <p>
                      ...
                      $25 materials fee
                      <br />
                      $35 lunch fee (optional - lunch provided for all 5 days or
                      student can bring their own or make other arrangements)
                    </p>
                ...
                <div className='col-lg-6 col-md-12' style={{ margin: '8em 0' }}>
                  <JamCampSignupForm />
                </div>
              </div>
            </div>
