...
class NavbarFive extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
            <SeoSection 
                title="Genial - Car Subscription Landing Page"
                desc="Genial is a React Next Landing Templates. This has been built with React, Next.js, Express.js, and ES6+."
                url="https://genial-react.envytheme.com/car-subscription"
            />
            <nav id="navbar" className="navbar navbar-expand-lg navbar-style-four navbar-light bg-light">
                <div className="container">
                    <Link href="/car-subscription">
